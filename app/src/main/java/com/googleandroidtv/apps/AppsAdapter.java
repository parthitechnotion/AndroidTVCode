...
import com.googleandroidtv.ActiveItemsRowView;
import com.googleandroidtv.LauncherViewHolder;
...
import com.googleandroidtv.apps.AppsAdapter.AppViewHolder;
import com.googleandroidtv.apps.AppsRanker.RankingListener;
import com.googleandroidtv.apps.LaunchPointListGenerator.Listener;
import com.googleandroidtv.bean.AppInfo;
import com.googleandroidtv.modle.db.AppInfoService;
import com.googleandroidtv.util.Lists.Change.Type;
...
public class AppsAdapter extends RowViewAdapter<AppViewHolder> implements RankingListener, Listener {
    ...
    class C01822 implements Runnable {
        ...
        public void run() {
            ...
            if (itemRemovedAt != -1) {
                ...
                int appcount = AppsAdapter.this.getItemCount();
                Log.e("TotalApps - ",String.valueOf(appcount));
    ...
    private class CustomAppViewHolder extends AppViewHolder {
        private final ImageView mIconView;
        private final TextView mLabelView;
        private final View mBannerView;
        private final BannerView rootView;
        ...
        public CustomAppViewHolder(View v, AppsAdapter appsAdapter) {
            super(v,appsAdapter);
        ...
        public void init(LaunchPoint launchPoint) {
            ...
            if (launchPoint != null) {
                ...
                if (this.mIconView != null) {
                 //   this.mIconView.setImageDrawable(icon);
                    Picasso.with(AppsAdapter.this.mContext).load(launchPoint.getPackageName()).into(this.mIconView);
                }
                if (this.mLabelView != null) {
                    this.mLabelView.setText(launchPoint.getTitle());
                }
...
/*            for (Change change : changes) {
    ...
    public AppViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            ...
            case 4:
                return new CustomAppViewHolder(this.mInflater.inflate(R.layout.custom_app_banner,parent,false),this);
            default:
                return null;
        }
    }
    ...
    public void onBindViewHolder(AppViewHolder holder, int position) {
        ...
        if (position < this.mLaunchPoints.size()) {
            ...
            Log.i(TAG, "onBindViewHolder->AppType:" + itemViewType);
    ...
    private ArrayList<LaunchPoint> getRefreshedLaunchPointList() {
        ...
        if (this.mAppType == 0) {
            ...
            launchPoints = this.mLaunchPointGen.getAllLaunchPoints();
        }else if(this.mAppType == 25){
            launchPoints = this.mLaunchPointGen.getCustom4LaunchPoints(MainActivity.CategotriesList);
        } else if(this.mAppType == 45){
            launchPoints = this.mLaunchPointGen.getRecentAppLaunchPoints();
        }
        //launchPoints = this.mLaunchPointGen.getAllLaunchPoints();
