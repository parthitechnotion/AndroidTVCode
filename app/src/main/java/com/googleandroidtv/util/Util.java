...
public class Util {
    ...
    public static void CopyDatabse() {
       // DBFilePath: /data/user/0/com.googleandroidtv/files/google_tvlauncher.db
        Log.e("DBFilePath",ConstData.DB_DIRECTORY+"/google_tvlauncher.db");
        File dbFile = new File(ConstData.DB_DIRECTORY+"/google_tvlauncher.db");

        String newFolder = "/GoogleTV";
        File exportDir = new File(Environment.getExternalStorageDirectory(),newFolder);
    ...
    public static Intent getSettingLaunchIntent(String Packagename, String ActivityName) {
