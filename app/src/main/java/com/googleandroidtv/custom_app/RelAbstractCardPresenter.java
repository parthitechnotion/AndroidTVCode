 ...
 */
public abstract class RelAbstractCardPresenter<T extends BaseCardView> extends Presenter {
     ...
     */
    public RelAbstractCardPresenter(Context context) {
        mContext = context;
    }
    ...
    @Override public final void onBindViewHolder(ViewHolder viewHolder, Object item) {
        RelatedApplicationListBean card = (RelatedApplicationListBean) item;
     ...
     */
    public abstract void onBindViewHolder(RelatedApplicationListBean card, T cardView);
